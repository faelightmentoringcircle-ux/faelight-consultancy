...
export default function MentoringPage() {
  return (
    <SubBrandPage
      ...
      lists={[
        { id: "mentoring-builds", title: "What learners build (Foundations)", items: MENTORING_BUILDS },
        { id: "leadership-themes", title: "Leadership & EVA themes", items: LEADERSHIP_THEMES },
      ]}
